...
export type VideoMetadataQuery = {
  __typename?: 'query_root';
  videos_by_pk?: { __typename?: 'videos'; metadata?: any | null } | null;
};

export type MarkVideoFailedMutationVariables = Exact<{
  videoId: Scalars['uuid']['input'];
  metadata: Scalars['jsonb']['input'];
}>;

export type MarkVideoFailedMutation = {
  __typename?: 'mutation_root';
  update_videos_by_pk?: { __typename?: 'videos'; id: any } | null;
};
...
>;
export const MarkVideoFailedDocument = new TypedDocumentString(`
